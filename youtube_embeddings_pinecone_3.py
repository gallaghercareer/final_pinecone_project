...
def query():
    ...
    messages = [
        {"role": "system", "content": "You are a helpful assistant. You are only to resopnd based on the prompt context given."},
        {"role": "user", "content": "Do not draw knowledge from anything but the prompt. Do not imagine or make up information in your response except for what can be deduced from the prompt and messages already here."}
    ]
